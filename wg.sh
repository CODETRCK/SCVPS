...
# Tambahan
cd /usr/bin
wget -O mwg "https://raw.githubusercontent.com/PREMIUM/VPS-SC/main/mwg.sh"
wget -O add-wg "https://raw.githubusercontent.com/PREMIUM/VPS-SC/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/PREMIUM/VPS-SC/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/PREMIUM/VPS-SC/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/PREMIUM/VPS-SC/main/renew-wg.sh"
chmod +x mwg
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
