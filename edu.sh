...
wget -q -O /usr/local/bin/edussh-nontls https://raw.githubusercontent.com/PREMIUM/VPS-SC/main/proxy-template.py
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/PREMIUM/VPS-SC/main/edu-op.py
